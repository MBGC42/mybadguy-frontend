...
function renderIntro() {
  let h = `
    <div class="screen">
      ...
      <h2 style="font-family:'Syne',sans-serif;font-size:clamp(20px,4vw,26px);font-weight:700;color:#1a1a1a;text-align:center;margin-bottom:.5rem;letter-spacing:-.01em;">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;margin-bottom:2rem;">
        ...
        <div style="background:#F0F4F8;border:1px solid #dde3ea;border-radius:14px;padding:1.25rem;position:relative;">
          ...
          <div style="font-family:'Syne',sans-serif;font-size:42px;font-weight:700;color:rgba(0,63,114,.35);line-height:1;margin-bottom:.65rem;">01</div>
        ...
        <div style="background:#F0F4F8;border:1px solid #dde3ea;border-radius:14px;padding:1.25rem;position:relative;">
          ...
          <div style="font-family:'Syne',sans-serif;font-size:42px;font-weight:700;color:rgba(0,63,114,.35);line-height:1;margin-bottom:.65rem;">02</div>
        ...
        <div style="background:#F0F4F8;border:1px solid #dde3ea;border-radius:14px;padding:1.25rem;position:relative;">
          ...
          <div style="font-family:'Syne',sans-serif;font-size:42px;font-weight:700;color:rgba(0,63,114,.35);line-height:1;margin-bottom:.65rem;">03</div>
...
function renderDevice() {
  ...
  // macOS: Safari UA only reports major.minor (e.g. 15.7 not 15.7.5)
  // Windows: UA always reports NT 10.0 regardless of Win10 or Win11
  ...
  const lowConfidence = partialDetection
    ? `<div style="margin-top:.75rem;padding:12px 14px;background:#FFF3CD;border:1px solid #f0c070;border-left:4px solid #EF9F27;border-radius:6px;font-size:15px;color:#7a4e00;line-height:1.6;">
        <strong style="display:block;margin-bottom:3px;">⚠️ Partial detection</strong>
        Safari only reports your major version — we cannot detect your exact macOS build. Tap <strong>Correct it</strong> to confirm your version from  → About This Mac.
      </div>`
    : '';
